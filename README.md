...
Пример: дана последовательность `unsigned char` `{0b10000000, 0b11000000, 0b11100000}`. Требуется прочитать из неё два 9-битных значения `a` и `b`.
Представление на битовом уровне:
```
10000000 11000000 11100000
aaaaaaaa abbbbbbb bb
01234567 80123456 78
```
